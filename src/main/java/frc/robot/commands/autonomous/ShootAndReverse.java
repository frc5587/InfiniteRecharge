...
public class ShootAndReverse extends SequentialCommandGroup {
    public ShootAndReverse(Arm arm, Conveyor conveyor, Drivetrain drivetrain, Intake intake, Limelight limelight, ShooterJRAD shooter) {
        addCommands(
