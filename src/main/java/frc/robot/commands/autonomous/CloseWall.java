...
public class CloseWall extends SequentialCommandGroup {
    public CloseWall(Arm arm, Conveyor conveyor, Drivetrain drivetrain, Intake intake, Limelight limelight, Shooter shooter, AutoPaths reverseToTrench, AutoPaths reverseUnderTrench, FindTarget findTarget, ArmThread armThread, ShooterThread shooterThread) {
        addCommands(
