...
public class Shooter extends SubsystemBase {
    ...
    private void configureSpark() {
        ...
        sparkPIDControllerOne.setOutputRange(-Constants.ShooterConstants.MIN_OUTPUT,
                Constants.ShooterConstants.MAX_OUTPUT);

        motorOne.setSmartCurrentLimit(40, 35);

        sparkPIDControllerTwo.setOutputRange(-Constants.ShooterConstants.MIN_OUTPUT,
                Constants.ShooterConstants.MAX_OUTPUT);
